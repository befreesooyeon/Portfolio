...
<div class="inner">
    ...
    ${renderMedia(project.overviewImage, project.title, 'project-overview-image')}
    </div>` : ''}
</div>
</section>` : ''}
...
<div class="inner">
    ...
    <div class="project-AddImg">
        ${project.solutionAddImg1 ? renderMedia(project.solutionAddImg1, project.title, 'add-image') : ''}
        ${project.solutionAddImg2 ? renderMedia(project.solutionAddImg2, project.title, 'add-image') : ''}
        ${project.solutionAddImg3 ? renderMedia(project.solutionAddImg3, project.title, 'add-image') : ''}
    </div>` : ''}
    </div>

    ${project.solutionImage ? `
    <div class="project-solution-media">
    ${renderMedia(project.solutionImage, project.title, 'project-solution-image')}
    </div>` : ''}
</div>
</section>` : ''}
...
<div class="imgBoxSli">
    ...
    <div class="Box1">
    ${project.box1Imgs.map(src => `<div class="imgItem">${renderMedia(src, project.title)}</div>`).join('')}
    </div>` : ''}

    ${project.box2Imgs?.length ? `
    <div class="Box2">
    ${project.box2Imgs.map(src => `<div class="imgItem">${renderMedia(src, project.title)}</div>`).join('')}
    </div>` : ''}
</div>` : ''}
...
<div class="phoneM">
    ${project.phone1Img ? `<div class="phone1">${renderMedia(project.phone1Img, project.title)}</div>` : ''}
    ${project.phone2Img ? `<div class="phone2">${renderMedia(project.phone2Img, project.title)}</div>` : ''}
    ${project.phone3Img ? `<div class="phone3">${renderMedia(project.phone3Img, project.title)}</div>` : ''}
</div>` : ''}
